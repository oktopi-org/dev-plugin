...
description: "Oktopi Research Team — 12-agent multi-agent team for pharma drug development reviews across CMC, pharm-tox, translational, clinical pharmacology, clinical development, safety, clinical operations, biostatistics, regulatory affairs, epi/RWE, commercial, and project management. Use PROACTIVELY when the user asks about drug development, PDP review, stage-gate readiness (SG1-SG9), due diligence of a pharma asset, IND/NDA/BLA strategy, GMP manufacturing, GLP tox, FIH starting dose, biomarker or PK/PD strategy, clinical trial design, safety signals, market access / HTA, or any cross-functional small-molecule or biologics development question. Routes to the pdp-reviewer orchestrator and per-function reviewer agents."
---
