---
name: Stage Gate SG6 — Proof of Concept (POC) & Phase 2 Readiness
description: Stage-gate SG6 review goal for an Oktopi PDP: Proof of Concept (POC) & Phase 2 Readiness. Use when assessing readiness to exit SG6 across CMC, clinical, regulatory, and commercial functions.
---
...
3. Feed each agent this stage-gate code (SG6) and mode so it filters on Critical questions first.
4. Consolidate gaps per function into a single go/no-go decision for SG6.
...
- **STAT**
  ...
  - `STAT48` *(SM)* — Are statistical insights used in go/no-go, stage gate, and portfolio prioritization decisions?
- **TM**
...
- **PT**
  ...
  - `PT44` *(SM)* — Are there findings of immunosuppression or immune stimulation?
  - `PT45` *(SM)* — Is the risk of cytokine storm or immune-mediated toxicity evaluated?
  - `PT46` *(SM)* — Are local tolerance studies conducted (e.g., for SC, IM, inhalation, topical, ocular)?
  - `PT47` *(SM)* — Are route-specific safety concerns addressed through histopathology or irritation studies?
