---
name: Stage Gate SG7 — Confirmatory & Phase 3 Readiness (Reg & Commercial aligned)
description: Stage-gate SG7 review goal for an Oktopi PDP: Confirmatory & Phase 3 Readiness (Reg & Commercial aligned). Use when assessing readiness to exit SG7 across CMC, clinical, regulatory, and commercial functions.
---
...
3. Feed each agent this stage-gate code (SG7) and mode so it filters on Critical questions first.
4. Consolidate gaps per function into a single go/no-go decision for SG7.
...
- **COM**
  ...
  - `COM2` *(SM)* — Are epidemiology and patient segmentation data available and credible?
  ...
  - `COM4` *(SM)* — Have analogs or benchmarks been used to triangulate market potential?
