---
name: Stage Gate SG5 — First-in-Human (FIH) Clinical Program Initiation
description: Stage-gate SG5 review goal for an Oktopi PDP: First-in-Human (FIH) Clinical Program Initiation. Use when assessing readiness to exit SG5 across CMC, clinical, regulatory, and commercial functions.
---
...
3. Feed each agent this stage-gate code (SG5) and mode so it filters on Critical questions first.
4. Consolidate gaps per function into a single go/no-go decision for SG5.
...
- **STAT**
  ...
  - `STAT47` *(SM)* — Are they involved in modeling and simulation to support dose and regimen decisions?
